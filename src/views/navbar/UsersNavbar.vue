...
<template>
  ...
  <li class="nav-item">
    <router-link to="/my-tasks" class="nav-link " href="index.html">
  ...
  <li class="nav-item">
    <router-link to="/goals" class="nav-link " href="index.html">
      <i class="bi bi-list-task"></i>
      <span>Goals</span>
    </router-link>
  </li>
  <li class="nav-item">
    <router-link to="/document" class="nav-link " href="index.html">
      <i class="bi bi-list-task"></i>
      <span>Documents</span>
    </router-link>
  </li>
